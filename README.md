...
- Android Studio (android-studio-2024.3.1.13-windows.exe) 
- Android SDK 35
...
- Update version classpath 'com.android.tools.build:gradle:8.9.2' // was 8.1.1
- Update version compileSdkVersion 35 in "AGKPlayer2\build.gradle"
