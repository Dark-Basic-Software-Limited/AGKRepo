...
int main( int argc, char* argv[] )
{
	...
	if (pUserName)
	{
		sprintf(szAPKSigner, "C:\\Users\\%s\\AppData\\Local\\Android\\Sdk\\build-tools\\36.0.0\\lib\\apksigner.jar", pUserName);
		sprintf(szZipAlign, "C:\\Users\\%s\\AppData\\Local\\Android\\Sdk\\build-tools\\36.0.0\\zipalign.exe", pUserName);
